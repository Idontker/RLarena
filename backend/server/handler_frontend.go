...
func ServeStatic(w http.ResponseWriter, r *http.Request) {
	...
	filePath := "./server" + r.URL.Path // Static files are located in the ./static folder
...
func InitHttpHandler_Frontend_Handler() {
	...
	http.HandleFunc("GET /leaderboard", func(w http.ResponseWriter, r *http.Request) {
		LogRequest(r)
		http.ServeFile(w, r, "./server/templates/leaderboard.html")
	})

	http.HandleFunc("GET /player", func(w http.ResponseWriter, r *http.Request) {
		LogRequest(r)
		http.ServeFile(w, r, "./server/templates/player.html")
	})
}
